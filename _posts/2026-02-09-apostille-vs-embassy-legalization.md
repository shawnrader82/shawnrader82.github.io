---
layout: post
title: Do I Need an Apostille or Embassy Legalization? How to Tell
description: Not sure if your document needs an apostille or embassy legalization? Learn the key differences, when each is required, and how to avoid costly mistakes in California.
date: 2026-02-09
categories:
  - apostille
tags:
...
image: /assets/images/blog/apostille-vs-legalization.jpg
---
...
An apostille is a special certificate that authenticates the signature of a public official on a document for use in a foreign country that is part of the [Hague Apostille Convention](https://www.hcch.net/en/instruments/conventions/specialised-sections/apostille).
...
1. Get the document properly issued or notarized.
2. Submit it to the **California Secretary of State** (or the U.S. Department of State for federal documents like FBI background checks).
3. Receive the apostille certificate attached to your document—done.

### Embassy Legalization (Multi-Step Path)

1. Get the document properly issued or notarized.
2. Obtain **state certification** from the California Secretary of State.
3. Obtain **federal authentication** from the U.S. Department of State (required for many documents).
4. Submit to the **foreign embassy or consulate** for final legalization.
...
1. Confirm whether the destination country is a **Hague Convention member**.
2. Check the country's **consulate or embassy website** for their document requirements.
3. Ask a professional apostille and legalization service to review your situation.
